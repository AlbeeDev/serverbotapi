...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'D:\.DOCUMENTI\JBWS\PyCharmWS\serverbotapi\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'D:\.DOCUMENTI\JBWS\PyCharmWS\serverbotapi\venv\Scripts\deactivate.nu'
